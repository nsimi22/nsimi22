...
const ICONS: Record<string, string> = {
  ...
  'folder-open': 'M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2v1M2 10l2.5 8h15l2.5-8H2z',
  'file': 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z M14 2v6h6',
  'file-code': 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z M14 2v6h6 M10 12l-2 2 2 2 M14 12l2 2-2 2',

  // Git
  'git-branch': 'M6 3v12M18 9a3 3 0 100-6 3 3 0 000 6zM6 21a3 3 0 100-6 3 3 0 000 6zM18 9a9 9 0 01-9 9',
  'git-commit': 'M12 16a4 4 0 100-8 4 4 0 000 8zM1.05 12H8M16 12h6.95',
  'git-pull-request': 'M18 21a3 3 0 100-6 3 3 0 000 6zM6 9a3 3 0 100-6 3 3 0 000 6zM6 9v12M18 9v6',
  ...
  // Misc
  'sparkles': 'M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM5 19l.5 1.5L7 21l-1.5.5L5 23l-.5-1.5L3 21l1.5-.5L5 19zM19 10l.5 1.5L21 12l-1.5.5L19 14l-.5-1.5L17 12l1.5-.5L19 10z',
...
// Circle icon with fill
export function CircleIcon({ size = 6, color = COLORS.text, filled = false }: { size?: number; color?: string; filled?: boolean }) {
  return (
